...
MenuItem.prototype.handleBlur = function (event) {
  ...
  setTimeout(this.menu.close.bind(this.menu, false,8), 300);
};
...
MenuItem.prototype.handleMouseout = function (event) {
    if (this.popupMenu) {
        if (this.popupMenu.domNode === event.relatedTarget) return;
        this.popupMenu.hasHover = false;
        this.popupMenu.close(true);
  }

  this.menu.hasHover = false;
  setTimeout(this.menu.close.bind(this.menu, false,9), 300);
};


MenuItem.prototype.isMenuBarDropdown = function () {
    var menubar = {};
    var menu = this.menu;
    while (true) {
        if (menu.isMenubar) {
