...
import MAP_DATA_FILE from "../Tiles-MapBox/GeoJSON-States.json";
export const localDataMap = fromJS(MAP_DATA_FILE);
...
export default class App extends Component {
  ...
  componentDidMount() {
    ...
    //this._loadData(fromJS({ type: "geojson", localDataMap }));
  }
