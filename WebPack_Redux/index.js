...
/***/ (function(module, exports, __webpack_require__) {
    ...
    */
    ...
    var store=Object(__WEBPACK_IMPORTED_MODULE_0_redux__["b" /* createStore */])(__WEBPACK_IMPORTED_MODULE_1__reducers__["a" /* default */]);store.subscribe(function(){console.log("Store changed",store.getState());});/* harmony default export */ __webpack_exports__["a"] = (store);
    ...
    "use strict";
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectBookAction__ = __webpack_require__(50);
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__listBooksAction__ = __webpack_require__(51);
    /* harmony default export */ __webpack_exports__["a"] = ({listBooksAction:__WEBPACK_IMPORTED_MODULE_1__listBooksAction__["a" /* default */],selectBookAction:__WEBPACK_IMPORTED_MODULE_0__selectBookAction__["a" /* default */]});
    ...
    */
    ...
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_bootstrap_dist_css_bootstrap_min_css__ = __webpack_require__(18);
    ...
    */
    var aa=__webpack_require__(6),ba=__webpack_require__(0),m=__webpack_require__(29),p=__webpack_require__(2),v=__webpack_require__(8),da=__webpack_require__(30),ea=__webpack_require__(31),fa=__webpack_require__(32),ha=__webpack_require__(7);
    ...
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bookListItem_component__ = __webpack_require__(39);
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_redux__ = __webpack_require__(3);
    var mapStateToProps=function mapStateToProps(state){return{books:state.listBooksReducer.books};};var BookList=function BookList(_ref){var books=_ref.books;return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"BookList"},books.map(function(book){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__bookListItem_component__["a" /* default */],{key:book.id,book:book});}));};/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_2_react_redux__["b" /* connect */])(mapStateToProps)(BookList));
    ...
    var changeSelectedBook=function changeSelectedBook(book){__WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].dispatch(__WEBPACK_IMPORTED_MODULE_2__actions__["a" /* default */].selectBookAction(book));};var BookListItem=function BookListItem(_ref){var book=_ref.book;return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'BookListItem'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'card',onClick:function onClick(){changeSelectedBook(book);}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'card-body'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h5',{className:'card-title'},book.name))));};/* harmony default export */ __webpack_exports__["a"] = (BookListItem);
    ...
    /* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(1), __webpack_require__(41)(module)))
    ...
    "use strict";
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_redux_src_combineReducers__ = __webpack_require__(44);
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__listBooksReducer__ = __webpack_require__(48);
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__selectedBookReducer__ = __webpack_require__(49);
    /* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_0_redux_src_combineReducers__["a" /* default */])({listBooksReducer:__WEBPACK_IMPORTED_MODULE_1__listBooksReducer__["a" /* default */],selectedBookReducer:__WEBPACK_IMPORTED_MODULE_2__selectedBookReducer__["a" /* default */]}));
    ...
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_actionTypes__ = __webpack_require__(45);
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_warning__ = __webpack_require__(46);
    /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_isPlainObject__ = __webpack_require__(47);
    ...
    function getUnexpectedStateShapeWarningMessage(
      ...
      const argumentName =
        action && action.type === __WEBPACK_IMPORTED_MODULE_0__utils_actionTypes__["a" /* default */].INIT
      ...
      if (!Object(__WEBPACK_IMPORTED_MODULE_2__utils_isPlainObject__["a" /* default */])(inputState)) {
        return (
      ...
      if (action && action.type === __WEBPACK_IMPORTED_MODULE_0__utils_actionTypes__["a" /* default */].REPLACE) return
    ...
    function assertReducerShape(reducers) {
      Object.keys(reducers).forEach(key => {
        ...
        const initialState = reducer(undefined, { type: __WEBPACK_IMPORTED_MODULE_0__utils_actionTypes__["a" /* default */].INIT })
        ...
        if (typeof reducer(undefined, { type }) === 'undefined') {
          throw new Error(
            `Reducer "${key}" returned undefined when probed with a random type. ` +
              `Don't try to handle ${
                __WEBPACK_IMPORTED_MODULE_0__utils_actionTypes__["a" /* default */].INIT
    ...
    "use strict";
    /* harmony export (immutable) */ __webpack_exports__["a"] = selectedBookReducer;
    function selectedBookReducer(){var state=arguments.length>0&&arguments[0]!==undefined?arguments[0]:[];var action=arguments[1];switch(action.type){case"LIST_BOOKS":return Object.assign({},state,{books:action.payload});break;default:return state;}}
    ...
    "use strict";
    /* harmony export (immutable) */ __webpack_exports__["a"] = selectedBookReducer;
    function selectedBookReducer(){var state=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var action=arguments[1];switch(action.type){case"SELECT_BOOK":return Object.assign({},state,{book:action.payload});break;default:return state;}}
    ...
    "use strict";
    /* unused harmony export SELECT_BOOK */
    /* harmony export (immutable) */ __webpack_exports__["a"] = selectBookAction;
    var SELECT_BOOK="SELECT_BOOK";function selectBookAction(books){return{type:SELECT_BOOK,payload:books};}
    ...
    "use strict";
    /* unused harmony export LIST_BOOKS */
    /* harmony export (immutable) */ __webpack_exports__["a"] = listBooksAction;
    var LIST_BOOKS="LIST_BOOKS";function listBooksAction(books){return{type:LIST_BOOKS,payload:books};}
    ...
    var mapStateToProps=function mapStateToProps(state){return{book:state.selectedBookReducer.book};};//
    ...
    // }
    //
    var BookDetailed=function BookDetailed(_ref){var book=_ref.book;return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"BookDetailed"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"card card-info"},book?__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"card-body"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h5",{className:"card-title"},book.name),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"card-text"},"By ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{className:"badge badge-dark"},book.author)),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",null,"Pages ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{className:"badge badge-info"},book.pages_i),"Price ",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{className:"badge badge-primary"},"$",book.price)),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("a",{className:"btn btn-primary"},"Buy Now")):__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",null,"No book selected")));};/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_1_react_redux__["b" /* connect */])(mapStateToProps)(BookDetailed));
    
    /***/ })
    /******/ ]);
    //# sourceMappingURL=main.cc45bfc2.js.map